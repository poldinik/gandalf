...
import {faBorderStyle, faEdit, faInfo, faLayerGroup, faTimes} from "@fortawesome/free-solid-svg-icons";
import {faSave} from "@fortawesome/free-solid-svg-icons/faSave";

const Piano = ({initType, onchange, modifica, onedit = () => {}}) => {
                                                        ...
                                                        <div onClick={onFieldClick} className="room-type-selector-item-label">
                                                            {
                                                                editMode ?
                                                                    <form>
                                                                        <input type="number" value={type} name="piano" min="0" onChange={onInputChange}/>
                                                                    </form>
                                                                    :
                                                                    type
                                                            }
