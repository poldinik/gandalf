...
const Altezza = ({initType, onchange, modifica, onedit = () => {}}) => {
    const [type, setType] = useState(initType);
    const icon = faArrowsAltV;
                                                        ...
                                                        <div onClick={onFieldClick} className="room-type-selector-item-label">
                                                            {
                                                                editMode ?
                                                                    <form>
                                                                        <input type="number" value={type} name="altezza" min="0" onChange={onInputChange}/>
                                                                    </form>
                                                                    :
                                                                    type + " mm".toLowerCase()
                                                            }
